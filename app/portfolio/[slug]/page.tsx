...
const projects = [
  {
    ...
    stackExplanation: "The app uses Angular for a fast, interactive UI, PrimeNG for component styling, RxJs and NgRx for state management, and Express/MongoDB for the backend API. GitHub is used for version control and collaboration. GitHub Actions for CI/CD. Playwright for automated UI tests. At one point, the platform was also integrated with Stripe to handle both subscriptions and one-time payments, but has since moved to a donation-based monetization model.",
