    ...
    <div className="flex flex-col min-h-screen bg-white text-black">
      ...
      <section className="w-full max-w-3xl mx-auto py-12 px-4" id="about-us">
        ...
        <p className="mb-6 text-center text-gray-700">
          As a software developer, I enjoy bridging the gap between engineering and design. My goal is always to build applications that are scalable and effecient under the hood while providing engaging, pixel-perfect user experiences
        </p>
        <p className="mb-6 text-center text-gray-700">
